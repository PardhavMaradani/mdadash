...
We welcome all contributions to mdadash!

Contributions can take many forms, such as:

- sharing bug reports or feature requests through the [Issue Tracker](https://github.com/MDAnalysis/mdadash/issues)
...
The second two options both involve making a [pull request](https://github.com/MDAnalysis/mdadash/pulls) .
